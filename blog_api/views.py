...
class PostDetails(APIView):
    ...
    def get(self, request, pk):
        ...
        currentPost = Post.objects.get(pk = pk);
        print("The value of the current post fetched from the database with the current id is as follows \n", currentPost);
        currentPost = PostSerializer(currentPost);
        # print("T")
